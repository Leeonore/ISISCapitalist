...
//////////////////Gestion des badges sur les boutons menu///////////////////////
    ...
    //Badges "new" sur les anges upgrade
                ...
                if (unlock.unlocked === false) { //si le unlock n'est pas en service
                    ...
                    newUnlocks = '<div class="row" id="u' + unlock.id + '">'
                                    ...
                                    + '<div class="description">'
                                        ...
                                        + '<div class="objectif">' + unlock.typeratio + " x"+ unlock.ratio +  ' sur tous les produits</div>'
                                    + '</div>'
                                + '</div>';
            ...
            $.each(currentWorld.angelupgrades.pallier, function (index, ange) {
                    ...
                    newAnge = '<div class="row" id="a' + n + '">'
                                    ...
                                    + '<div class="description">'
                                        ...
                                        + '<div class="objectif">' + ange.typeratio + " x" + ange.ratio + " sur " + cible +'</div>'
                                    + '</div>'
                                    + '<button class="btn btn-default" disabled type="submit">Buy !</button>'
                                + '</div>';
...
////////////////////////////////////////////////////////////////////////////////
    ...
    // Fonction pour récuperer la cible des bonus
    function CaculCible(objet) {
        var cible;
        if (objet.idcible > 0) {
            cible = currentWorld.products.product[objet.idcible - 1].name;
        } else if (objet.idcible === 0) {
